...
- [Ruby koans](http://rubykoans.com/) are a way to learn the ruby language via test-driven development; each step involves making a test case pass to help you understand a ruby language feature.
